...
- Create Angular project with ng: `ng new dcbotfrontend.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`dcbotfrontend.client.esproj`).
