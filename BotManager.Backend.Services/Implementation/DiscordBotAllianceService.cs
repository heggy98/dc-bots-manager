...
namespace BotManager.Backend.Services.Implementation
{
    public class DiscordBotAllianceService : IDiscordBotService
    {
        ...
        private async Task ReadyAsync()
        {
            ...
            {
                await RegisterDefaultSlashCommandsAsync();
        ...
        private async Task RegisterDefaultSlashCommandsAsync()
        {
            if (_client == null)
            {
                return;
            ...
            var commands = new List<ApplicationCommandProperties>
            {
                new SlashCommandBuilder()
                    ...
                    .AddOption("kontakt", ApplicationCommandOptionType.String, "Kontaktní informace na tým.", isRequired: true)
                    .Build(),
                ...
                new SlashCommandBuilder()
                    ...
                    .AddOption("novy-nazev", ApplicationCommandOptionType.String, "Nový název týmu", isRequired: false)
                    .AddOption("novy-velitel", ApplicationCommandOptionType.String, "Nový velitel", isRequired: false)
                    .AddOption("novy-kontakt", ApplicationCommandOptionType.String, "Nový kontakt", isRequired: false)
                    .Build(),

                new SlashCommandBuilder()
                    .WithName("seznam-tymu")
                    .WithDescription("Zobrazí seznam všech týmů (Admin)")
                    .AddOption("aktualizovat", ApplicationCommandOptionType.Boolean, "Aktualizovat zprávu v kanálu", isRequired: false)
                    .Build(),

                new SlashCommandBuilder()
                    .WithName("reorganizeemojis")
                    .WithDescription("Reorganizuje emoji zprávu (Admin)")
                    .AddOption("pokus", ApplicationCommandOptionType.Integer, "Číslo pokusu", isRequired: false)
                    .Build(),

                new SlashCommandBuilder()
                    .WithName("presun-reakce")
                    .WithDescription("Přesune zprávu pro výběr role do nového kanálu (Admin)")
                    .AddOption("cilovy_kanal", ApplicationCommandOptionType.Channel, "Cílový textový kanál", isRequired: true)
                    .Build()
            };
