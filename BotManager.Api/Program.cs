...
using BotManager.Api.BotPlugins.DiscordBotAlliancePlugin.Services;
using Serilog;
...
try
{
    ...
    builder.Services.AddScoped<DiscordAllianceCommandService>();
    builder.Services.AddScoped<IDiscordAllianceCommandService>(sp => sp.GetRequiredService<DiscordAllianceCommandService>());
    builder.Services.AddScoped<IDiscordCommandProvider>(sp => sp.GetRequiredService<DiscordAllianceCommandService>());
